...
double? _d(dynamic v) => v == null ? null : v is double ? v : v is num ? v.toDouble() : v is String ? double.tryParse(v) : null;
bool? _b(dynamic v) => v is bool ? v : v is num ? v == 1 : v is String ? (v == '1' || v.toLowerCase() == 'true') : null;
Map<String, dynamic> _m(dynamic v) => v is Map<String, dynamic> ? v : v is Map ? Map<String, dynamic>.from(v) : <String, dynamic>{};

OwnerOrderDetailsModel ownerOrderDetailsModelFromJson(dynamic value) => OwnerOrderDetailsModel.fromJson(_m(value));
String ownerOrderDetailsModelToJson(OwnerOrderDetailsModel data) => json.encode(data.toJson());

class OwnerOrderDetailsModel {
  final OwnerOrderDetailsData? data;
  final String? message;
  const OwnerOrderDetailsModel({this.data, this.message});
  factory OwnerOrderDetailsModel.fromJson(Map<String, dynamic> json) => OwnerOrderDetailsModel(
        data: json['data'] is Map ? OwnerOrderDetailsData.fromJson(_m(json['data'])) : null,
...
class OwnerOrderCustomer {
  ...
  factory OwnerOrderCustomer.fromJson(Map<String, dynamic> json) => OwnerOrderCustomer(id: _i(json['id']), name: _s(json['name']), phone: _s(json['phone']) ?? _s(json['mobile']), email: _s(json['email']));
