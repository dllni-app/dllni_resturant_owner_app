        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              AppText.titleMedium(
                '${amounts.total.toStringAsFixed(0)} ل.س',
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xff24B364).withAlpha(25),
              borderRadius: BorderRadius.circular(20),
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Icon(Icons.money, size: 16, color: Color(0xff24B364)),
    ...
    return Row(
      ...
      children: [
        ...
        AppText.bodyMedium(
          ...
          color: isDiscount ? const Color(0xff24B364) : const Color(0xff2F2B3D),
          fontWeight: FontWeight.bold,
        ),
      ],
    );
