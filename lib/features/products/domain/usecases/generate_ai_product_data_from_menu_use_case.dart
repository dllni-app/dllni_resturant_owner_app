...
@lazySingleton
class GenerateAiProductDataFromMenuUseCase
    implements
        UseCase<
  ...
  @override
  DataResponse<GenerateAiProductDataFromMenuModel> call(
...
class GenerateAiProductDataFromMenuParams with Params {
  ...
  GenerateAiProductDataFromMenuParams({required this.image, this.locale});
