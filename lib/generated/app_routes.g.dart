  ...
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/performance-reports':
        return MaterialPageRoute(builder: (_) => PerformanceReportsScreen(), settings: settings);
      case '/inventory/new':
        if (args is CreateInventoryItemScreenParams) {
          return MaterialPageRoute(builder: (_) => CreateInventoryItemScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/main':
        if (args is int?) {
          return MaterialPageRoute(builder: (_) => MainScreen(mainScreenParam: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/orders/details':
        if (args is OrderDetailsParams) {
          return MaterialPageRoute(builder: (_) => OrderDetailsScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/products/new_product':
        if (args is AddNewProductScreenParams) {
          return MaterialPageRoute(builder: (_) => AddNewProductScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/products/new_product/ai':
        return MaterialPageRoute(builder: (_) => AddProductAIScreen(), settings: settings);
      case '/products/new_product/details':
        if (args is AddProductDetailsScreenParams) {
          return MaterialPageRoute(builder: (_) => AddProductDetailsScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/products/new_product/menu':
        return MaterialPageRoute(builder: (_) => AddProductMenuScreen(), settings: settings);
      case '/employeesmanagement/new':
        if (args is AddEmployeeScreenParams) {
          return MaterialPageRoute(builder: (_) => AddEmployeeScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/couponsmanagement':
        return MaterialPageRoute(builder: (_) => CouponsManagementScreen(), settings: settings);
      case '/couponsmanagement/new':
        if (args is CreateCouponScreenParams?) {
          return MaterialPageRoute(builder: (_) => CreateCouponScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/offersmanagement/new':
        if (args is CreateOfferScreenParams?) {
          return MaterialPageRoute(builder: (_) => CreateOfferScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/employeesmanagement':
        return MaterialPageRoute(builder: (_) => EmployeesManagementScreen(), settings: settings);
      case '/employees/activity':
        return MaterialPageRoute(builder: (_) => EmployeeActivityScreen(), settings: settings);
      case '/offersmanagement':
        return MaterialPageRoute(builder: (_) => OffersManagementScreen(), settings: settings);
      case '/profile/map':
        if (args is PickLocationMapParams) {
          return MaterialPageRoute(builder: (_) => PickLocationMapScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/profile':
        if (args is ProfileScreenParams) {
          return MaterialPageRoute(builder: (_) => ProfileScreen(params: args), settings: settings);
        }
        return _errorRoute(settings);
      case '/support':
        return MaterialPageRoute(builder: (_) => SupportScreen(), settings: settings);
      case '/workingtime':
        return MaterialPageRoute(builder: (_) => WorkingTimeScreen(), settings: settings);
    }
